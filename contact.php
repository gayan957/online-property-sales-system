...
<body>
   ...
   <nav class="navbar">
    ...
    <section style="padding: 40px 20px; display: flex; flex-wrap: wrap; justify-content: center; gap: 50px; background-color: #f4f4f4;">
        ...
        <div style="background-color: #fff; padding: 20px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); max-width: 400px; width: 100%;">
            ...
            <p style="color: #666;">
                ...
                <strong>Email:</strong> support@onlinepropertysales.com<br>
                <strong>Address:</strong> 123 Real Estate Lane, City, State, Zip Code
            </p>

            <h3 style="color: #333; margin-top: 30px;">Office Hours</h3>
            <p style="color: #666;">
    ...
    <section style="padding: 40px 20px; background-color: #eaeaea; text-align: center;">
        ...
        <img src="images/location.jpg" style="width:600px; height:450px;" alt="" class="src">
    </section>
